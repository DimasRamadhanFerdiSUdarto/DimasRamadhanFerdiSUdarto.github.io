# DimasRamadhanFerdiSUdarto.github.io
<html lang="en">
    ...
    <header class="container bg-dark text-white">
        <div class="row">
            <div class="col-12 py-4 text-center">
                <h1 class="display-1">Presidensi G20 </h1>
    ...
    <main class="container border">
        <div class="row">
            <div class="col-md-6 py-5">
                ...
                <img class="w-100" src="1.jpg" alt="gambar alam">
            ...
            <div class="col-md-6 py-5">
                <img class="w-100" src="2.jpg" alt="gambar alam">
